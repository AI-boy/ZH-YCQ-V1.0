	...
	; Compiler options:
	;
	; -oYCQ.cof -mYCQ.map --summary=default --output=default delay.p1 \
	; interrupt.p1 led.p1 main.p1 Modbus.p1 pwm.p1 timer.p1 uart.p1 \
	; lcd12864.p1 beep.p1 key.p1 --chip=16F1938 -ID:\MCUProject\YCQ\include \
