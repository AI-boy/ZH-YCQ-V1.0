	...
	switch(key_temp)
	  {
	     ...
	     case 0x0020: KEY_VALUE =K7;KEY_STATE =KEY_DOWN;break;  //K7 按键	“背光”--“监测”
	   
	     case 0x0010: KEY_VALUE =K8;KEY_STATE =KEY_DOWN;break;  //K8 按键	“监测”--“设置”
